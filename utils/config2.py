...
class Config2(object):
    ...
    def __init__(self, load=True, cfg_dict=None, cfg_level=None):
        ...
        if load:
            ...
            self.OUTPUT_DIR = self.OUTPUT_DIR + f"_{formatted_time}"
    ...
    def _parse_args(self):
        ...
        parser.add_argument(
            ...
            default="/data/UCF101_1shot_v1.yaml"
        )
        parser.add_argument(
            "--init_method",
    ...
    def _initialize_cfg(self):
        ...
        if self.need_initialization:
            ...
            if os.path.exists('./configs/pool/base.yaml'):
                ...
                with open("/data/configs/pool/base.yaml", 'r') as f:
                    cfg = yaml.load(f.read(), Loader=yaml.SafeLoader)
        return cfg
    ...
    def _update_dict(self, cfg_dict):
        ...
        def recur(key, elem):
            if type(elem) is dict:
                return key, Config2(load=False, cfg_dict=elem, cfg_level=key)
            else:
